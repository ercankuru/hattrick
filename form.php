...
<div align="center">
  <table width="750" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="474" colspan="2" valign="top" >
	
	  
	    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-image:url(images/x_07.jpg)">
	      <!--DWLayoutTable-->
	      ...
	      <tr>
	        <td  height="30" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
	          <!--DWLayoutTable-->
	          <tr>
	            <td width="655" height="30" valign="top"><?php include('form/form.php');?> <a href="index.php">ana sayfa </a></td>
              </tr>
            </table>          </td>
          </tr>
	      <tr>
	        <td width="655"  height="444">&nbsp;</td>
          </tr>
                      </table></td>
    </tr>
